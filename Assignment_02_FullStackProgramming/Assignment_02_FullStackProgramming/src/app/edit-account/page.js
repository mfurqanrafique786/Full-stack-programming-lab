  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f4f8' }}>
      ...
      <div style={{ maxWidth: '960px', margin: '20px auto', padding: '0 20px' }}>
        <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'User Account', href: '/my-account' }, { label: 'Edit profile details' }]} />
        <h1 style={{ fontSize: '22px', fontWeight: 'bold', marginBottom: '20px' }}>Edit Profile details</h1>
        <div style={{ background: '#fff', padding: '30px', borderRadius: '2px' }}>
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
              <label style={{ fontSize: '12px', width: '160px', textAlign: 'right', paddingRight: '10px' }}>
          ...
          <div style={{ marginLeft: '160px', marginTop: '8px' }}>
            <button style={{
              background: '#5cb85c', color: '#fff', padding: '8px 20px',
              border: 'none', fontWeight: 'bold', fontSize: '13px', cursor: 'pointer', borderRadius: '2px'
